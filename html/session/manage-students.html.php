            ...
            <div class="panel-body">
              <div class="sidebar">
                <div class='list-group'>
                  ...
                  <a class='list-group-item active'  href="students.php">Student Accounts</a>
...
<!-- List of students registered in database -->
                    ...
                    <td><center>'.$row['Contact_Number'].'</center></td>
            				<td><center>'.$row['Current_Grade'].'</center></td>
                    <td><center>'.$row['Predicted_Grade'].'</center></td>
            				<td><center>'.$row['Aspirational_Grade'].'</center></td>
            			</tr>';
            		mysqli_close($db);
            		?>
              </tr>
